...
final class ServerTests: XCTestCase {
  ...
  func testGetLocation() async throws {
    let response = try await handler.getLocation(query: .init(
    ...
    XCTAssertEqual(location.cuisines, [
    ...
    XCTAssertEqual(location.photoURLs, [
      URL(string: "https://media-cdn.tripadvisor.com/media/photo-o/06/09/b0/2d/old-ebbitt-grill.jpg")!.absoluteString,
      URL(string: "https://media-cdn.tripadvisor.com/media/photo-o/07/e2/65/1a/old-ebbitt-grill.jpg")!.absoluteString,
      URL(string: "https://media-cdn.tripadvisor.com/media/photo-o/05/bc/2b/37/old-ebbitt-grill.jpg")!.absoluteString,
      URL(string: "https://media-cdn.tripadvisor.com/media/photo-o/07/e2/65/31/old-ebbitt-grill.jpg")!.absoluteString,
      URL(string: "https://media-cdn.tripadvisor.com/media/photo-o/07/e2/65/2b/old-ebbitt-grill.jpg")!.absoluteString
    ])
  }
}
